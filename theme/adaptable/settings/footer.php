...
// Top footer setting
$name = 'theme_adaptable/showtopfooterblock';
$title = get_string('showtopfooterblock', 'theme_adaptable');
$description = get_string('showtopfooterblockdesc', 'theme_adaptable');
