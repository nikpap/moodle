...
<?php
    if ($CFG->version > 2015051100 && !empty($PAGE->theme->settings->enablepass)) { ?>
        <li>
        <a href="<?php p($CFG->wwwroot) ?>/login/change_password.php"
            title="<?php echo get_string('changepassword') ?>">
            <i class="fa fa-key"></i><?php echo get_string('changepassword') ?>
        </a>
        </li>
<?php
    }
...
?>
 ...
 <div class="pull-right" id="top-header-navbar">
...
// if (has_capability('moodle/course:manageactivities', context_module::instance($info->id))) {
?>
    <div id="navwrap">
        <div class="container">
            <div class="navbar">
