...
if ($PAGE->pagelayout == 'incourse') {
    $formatrenderer = $PAGE->get_renderer('format_dynamictabs');
    echo $formatrenderer->render_tabs();
    // echo $formatrenderer->render_section_navigation();
}
echo $OUTPUT->course_content_header();
echo $OUTPUT->main_content();
echo $OUTPUT->course_content_footer();
if ($PAGE->pagelayout == 'incourse') {
    echo $formatrenderer->render_previous_next();
}
?>
</section>
