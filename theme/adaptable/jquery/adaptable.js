...
if ($('#page-login-index').length > 0 ) {
    ...
    var ajaxurl = M.cfg.wwwroot+'/theme/adaptable/ajax/themesettings.php';
    // console.log('success login ' + M.cfg.sesskey);
    $.ajax({
      url: ajaxurl,
      cache: false,
      data: { setting: "loginbackgrounds", sesskey: M.cfg.sesskey}
        ...
        if (msg.result == 'success') {
            console.log(msg.loginimages);
            $("#page").backstretch(msg.loginimages, {'duration': 10000, 'fade': 250});
        } else {
            console.log('FAILURE login js');    
        }
    });
}
